...
from bot.states.states import CompanyCreationStates, CompanyJoinStates, CompanyManagementStates
from bot.utils.handlers.menu import send_mentor_menu, send_trainee_menu
...
async def finalize_company_creation(message: Message, state: FSMContext, session: AsyncSession, phone_number: str, bot):
    ...
    try:
        ...
        if user:
            ...
            from bot.keyboards.keyboards import get_keyboard_by_role
