...
from bot.handlers.fallback import company, grouped, knowledge, registration, tests, training, universal
from bot.utils.messages.fallback import send_fallback_message, send_use_buttons_message
