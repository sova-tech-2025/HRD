...
from bot.database.db import check_user_permission, get_user_by_tg_id, get_user_roles
from bot.keyboards.keyboards import format_help_message, get_menu_by_role
from bot.utils.auth.auth import check_auth
from bot.utils.bot.roles import get_primary_role
from bot.utils.handlers.callback import cleanup_callback
from bot.utils.handlers.user import get_validated_user
from bot.utils.logger import log_user_action, logger
from bot.utils.messages.common import (
    format_profile_text,
    get_main_menu_text,
