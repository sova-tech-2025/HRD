...
class TestSendFallbackMessage:
    ...
    async def test_sends_fallback_with_keyboard(self):
        ...
        from bot.utils.messages.fallback import send_fallback_message

        msg = make_message()
        state = make_state()

        with patch("bot.utils.messages.fallback.get_fallback_keyboard", return_value="kb_mock"):
...
class TestSendUseButtonsMessage:
    ...
    async def test_sends_use_buttons(self):
        ...
        from bot.utils.messages.fallback import send_use_buttons_message
...
class TestUnexpectedNameInput:
    ...
    async def test_short_name_shows_error(self):
        ...
        from bot.handlers.fallback.registration import handle_unexpected_name_input
    ...
    async def test_valid_name_gets_fallback(self):
        ...
        with patch("bot.utils.messages.fallback.get_fallback_keyboard", return_value="kb"):
            await handle_unexpected_name_input(msg, state)
...
class TestUnexpectedMaterialsInput:
    ...
    async def test_photo_rejected(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_materials_input
...
class TestUnexpectedTestNameInput:
    ...
    async def test_short_name_error(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_test_name_input
...
class TestUnexpectedQuestionTextInput:
    ...
    async def test_short_question_error(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_question_text_input
...
class TestUnexpectedAnswerInput:
    ...
    async def test_single_choice_hint(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_answer_input
...
class TestUnexpectedPointsInput:
    ...
    async def test_negative_points_error(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_points_input
...
class TestUnexpectedThresholdInput:
    ...
    async def test_shows_max_score(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_threshold_input
...
class TestUnexpectedTestInput:
    ...
    async def test_no_questions_clears_state(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_test_input
...
class TestUnexpectedQuestionEdit:
    ...
    async def test_short_question_error(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_question_edit
...
class TestUnexpectedNewThreshold:
    ...
    async def test_zero_threshold_error(self):
        """Ноль — ошибка"""
        from bot.handlers.fallback.tests import handle_unexpected_new_threshold
...
class TestKnowledgeBaseFolderName:
    ...
    async def test_non_text_shows_error(self):
        ...
        from bot.handlers.fallback.knowledge import handle_unexpected_folder_name_input
...
class TestUnexpectedInputWithState:
    ...
    async def test_unregistered_user_gets_welcome(self):
        ...
        from bot.handlers.fallback.universal import handle_unexpected_input_with_state
        ...
        with (
            patch("bot.handlers.fallback.universal.get_user_by_tg_id", return_value=None),
            patch("bot.handlers.fallback.universal.log_user_action"),
        ):
    ...
    async def test_registered_user_with_state_gets_fallback(self):
        ...
        with (
            patch("bot.handlers.fallback.universal.get_user_by_tg_id", return_value=user),
            patch("bot.handlers.fallback.universal.get_fallback_keyboard", return_value="kb"),
            patch("bot.handlers.fallback.universal.log_user_action"),
        ):
            await handle_unexpected_input_with_state(msg, state, session)
    ...
    async def test_registered_user_no_state_gets_fallback(self):
        ...
        with (
            patch("bot.handlers.fallback.universal.get_user_by_tg_id", return_value=user),
            patch("bot.utils.messages.fallback.get_fallback_keyboard", return_value="kb"),
        ):
            await handle_unexpected_input_with_state(msg, state, session)
...
class TestUnexpectedCallback:
    ...
    async def test_callback_answered_and_edited(self):
        ...
        from bot.handlers.fallback.universal import handle_unexpected_callback
...
class TestUnexpectedOptionInput:
    ...
    async def test_empty_option_error(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_option_input
...
class TestUnexpectedPhoneInput:
    ...
    async def test_shows_phone_format_hint(self):
        ...
        from bot.handlers.fallback.registration import handle_unexpected_phone_input
...
class TestUnexpectedRoleInput:
    ...
    async def test_shows_role_error_with_keyboard(self):
        ...
        from bot.handlers.fallback.registration import handle_unexpected_role_input

        msg = make_message(text="admin")
        state = make_state()

        with patch("bot.handlers.fallback.registration.get_role_selection_keyboard", return_value="role_kb"):
...
class TestUnexpectedTestCompleted:
    ...
    async def test_shows_test_completed(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_test_completed
...
class TestUnexpectedDateInput:
    ...
    async def test_shows_date_format_hint(self):
        ...
        from bot.handlers.fallback.training import handle_unexpected_date_input
...
class TestUnexpectedTimeInput:
    ...
    async def test_shows_time_format_hint(self):
        ...
        from bot.handlers.fallback.training import handle_unexpected_time_input
...
class TestUnexpectedScoreInput:
    ...
    async def test_shows_score_format_hint(self):
        ...
        from bot.handlers.fallback.training import handle_unexpected_score_input
...
class TestUnexpectedCompanyNameEditInput:
    ...
    async def test_shows_text_expected(self):
        ...
        from bot.handlers.fallback.company import handle_unexpected_company_name_edit_input
...
class TestUnexpectedCompanyDescriptionEditInput:
    ...
    async def test_shows_text_expected(self):
        """Некорректный ввод — ожидается текст"""
        from bot.handlers.fallback.company import handle_unexpected_company_description_edit_input
...
class TestUnexpectedAttestationConfirmationInput:
    ...
    async def test_shows_use_buttons(self):
        ...
        from bot.handlers.fallback.training import handle_unexpected_attestation_confirmation_input
...
class TestUnexpectedNewMaterials:
    ...
    async def test_shows_retry(self):
        ...
        from bot.handlers.fallback.tests import handle_unexpected_new_materials
...
class TestUnexpectedAttestationQuestionInput:
    ...
    async def test_shows_format_hint(self):
        ...
        from bot.handlers.fallback.training import handle_unexpected_attestation_question_input
...
class TestUnexpectedTestMaterialsInput:
    ...
    async def test_shows_format_hint(self):
        ...
        from bot.handlers.fallback.training import handle_unexpected_test_materials_input
...
class TestUnexpectedMaterialNameInput:
    ...
    async def test_non_text_shows_error(self):
        """Не текст — ошибка формата"""
        from bot.handlers.fallback.knowledge import handle_unexpected_material_name_input
...
class TestUnexpectedMaterialContentInput:
    ...
    async def test_non_text_non_doc_shows_error(self):
        ...
        from bot.handlers.fallback.knowledge import handle_unexpected_material_content_input
...
class TestUnexpectedMaterialDescriptionInput:
    ...
    async def test_non_text_shows_error(self):
        """Не текст — ошибка"""
        from bot.handlers.fallback.knowledge import handle_unexpected_material_description_input
...
class TestUnexpectedMaterialPhotosInput:
    ...
    async def test_non_photo_shows_error(self):
        """Не фото — ошибка"""
        from bot.handlers.fallback.knowledge import handle_unexpected_material_photos_input
...
class TestUnexpectedNewTestName:
    ...
    async def test_short_name_error(self):
        """Название < 3 символов — ошибка"""
        from bot.handlers.fallback.tests import handle_unexpected_new_test_name
...
class TestUseButtonsStates:
    ...
    async def test_sends_use_buttons(self):
        ...
        from bot.handlers.fallback.grouped import handle_use_buttons_states
...
class TestTextRetryStates:
    ...
    async def test_sends_retry(self):
        ...
        from bot.handlers.fallback.grouped import handle_text_retry_states
...
class TestUnexpectedGroupNameInput:
    ...
    async def test_shows_error(self):
        ...
        from bot.handlers.fallback.grouped import handle_unexpected_group_name_input
...
class TestUnexpectedObjectNameInput:
    ...
    async def test_shows_error(self):
        ...
        from bot.handlers.fallback.grouped import handle_unexpected_object_name_input
...
class TestUnexpectedNameInputs:
    ...
    async def test_shows_error(self):
        ...
        from bot.handlers.fallback.grouped import handle_unexpected_name_inputs
...
class TestUnexpectedNumericInputs:
    ...
    async def test_shows_error(self):
        """Некорректное число"""
        from bot.handlers.fallback.grouped import handle_unexpected_numeric_inputs
...
class TestUnexpectedLpTestTextInputs:
    ...
    async def test_shows_error(self):
        ...
        from bot.handlers.fallback.grouped import handle_unexpected_lp_test_text_inputs
...
class TestGenericFallbackStates:
    ...
    async def test_sends_fallback(self):
        ...
        from bot.handlers.fallback.grouped import handle_generic_fallback_states
