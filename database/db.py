...
async def get_trainee_available_tests(session: AsyncSession, trainee_id: int, company_id: int = None) -> List[Test]:
    ...
    """
    try:
        from database.models import LearningSession, TraineeLearningPath, TraineeSessionProgress, TraineeStageProgress
...
async def update_user_role(
    ...
    try:
        from database.models import Mentorship, TraineeAttestation, TraineeLearningPath, TraineeTestAccess
...
async def get_trainees_without_mentor(session: AsyncSession, company_id: int = None) -> List[User]:
    ...
    try:
        from database.models import Mentorship, Role, User
...
async def _create_trainee_progress(session: AsyncSession, trainee_path_id: int, learning_path_id: int) -> None:
    ...
    try:
        from database.models import LearningSession, LearningStage, TraineeSessionProgress, TraineeStageProgress
...
async def open_stage_for_trainee(
    ...
    try:
        from database.models import TraineeSessionProgress, TraineeStageProgress
...
async def send_stage_opened_notification(
    ...
    try:
        from database.models import LearningStage, User
...
async def get_trainee_stage_progress(
    ...
    try:
        from database.models import LearningStage, TraineeLearningPath, TraineeStageProgress
...
async def get_stage_session_progress(session: AsyncSession, stage_progress_id: int) -> List[TraineeSessionProgress]:
    ...
    try:
        from database.models import LearningSession, TraineeSessionProgress
...
async def complete_stage_for_trainee(
    ...
    try:
        from database.models import LearningPath, TraineeLearningPath, TraineeStageProgress, User
...
async def get_learning_path_stages(
    ...
    try:
        from database.models import LearningPath, LearningStage
...
async def get_session_with_tests(
    ...
    try:
        from database.models import LearningPath, LearningSession, LearningStage
...
async def get_session_tests(session: AsyncSession, session_id: int, company_id: int = None) -> List[Test]:
    ...
    try:
        from database.models import session_tests
...
async def check_session_has_trainees(session: AsyncSession, session_id: int, company_id: int = None) -> bool:
    ...
    try:
        from database.models import LearningPath, LearningSession, LearningStage, TraineeLearningPath, User
...
async def change_trainee_to_employee(
    ...
    """
    try:
        from database.models import LearningPath, Mentorship, TraineeLearningPath
...
async def make_manager_decision(
    ...
    """
    try:
        from database.models import Attestation, AttestationResult, User
...
async def get_trajectory_usage_info(session: AsyncSession, trajectory_id: int, company_id: int = None) -> dict:
    ...
    try:
        from database.models import LearningPath, TraineeLearningPath, User
