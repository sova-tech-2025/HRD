...
from database.models import LearningPath, LearningSession, LearningStage, Test
from utils.formatters.test_progress import format_test_with_percentage, get_test_status_icon
...
async def generate_trajectory_progress_with_attestation_status(
    ...
    from database.db import get_trainee_attestation_status, get_user_by_id
